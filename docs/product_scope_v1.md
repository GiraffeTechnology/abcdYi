...
- Version boundary: v1.0 covers full order execution lifecycle for apparel/textile; multi-tenant SaaS and mobile are v2.0+
- Production readiness: passes acceptance scenario 5x reproducibly; no hardcoded data in product logic; all external actions require human approval
