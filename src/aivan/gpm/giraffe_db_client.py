...
class GiraffeDBClient:
    ...
    def _service_headers(self, tenant_id: Optional[str]) -> dict[str, str]:
    ...
    def create_packet(self, packet: dict, tenant_id: Optional[str] = None) -> dict:
    ...
    def get_packet(self, packet_id: str, tenant_id: Optional[str] = None) -> Optional[dict]:
