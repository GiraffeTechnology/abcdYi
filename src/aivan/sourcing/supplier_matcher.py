...
def _score_moq(required_qty: Optional[int], moq_min: int, moq_max: int) -> float:
...
def _score_capacity(required_qty: Optional[int], daily_cap: int, monthly_cap: int, delivery_days: Optional[int]) -> float:
