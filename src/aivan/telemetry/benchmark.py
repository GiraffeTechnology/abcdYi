...
def configure_expected_local_model(provider: Optional[str] = None, model: Optional[str] = None) -> None:
...
def _run_one(case: BenchmarkCase, mode_key: str, per_case_timeout: Optional[float]) -> dict:
...
def run_benchmark(
    ...
    *,
    on_case=None,
    per_case_timeout: Optional[float] = None,
    fail_fast: bool = False,
    max_local_failure_rate: Optional[float] = None,
) -> dict:
