...
def is_external_provider(provider: Optional[str]) -> bool:
...
def has_active_external_approval(provider: str, task: Optional[str] = None) -> bool:
...
def assert_provider_allowed(provider: str, task: Optional[str] = None) -> None:
