...
class DraftRepository:
    ...
    def get(self, draft_id: str) -> Optional[InquiryDraftRecord]:
    ...
    def approve(self, draft_id: str, approved_by: str = "user") -> Optional[InquiryDraftRecord]:
    ...
    def reject(self, draft_id: str) -> Optional[InquiryDraftRecord]:
    ...
    def mark_sent(self, draft_id: str) -> Optional[InquiryDraftRecord]:
        d = self.get(draft_id)
        if d:
            d.status = "sent"
    ...
    def mark_approved_pending_send(self, draft_id: str, approved_by: str = "user") -> Optional[InquiryDraftRecord]:
    ...
    def mark_send_failed(self, draft_id: str, reason: str = "") -> Optional[InquiryDraftRecord]:
