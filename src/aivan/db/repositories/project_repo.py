...
class ProjectRepository:
    ...
    def get_by_conversation(self, conversation_id: str) -> Optional[Project]:
    ...
    def update_requirement(self, project_id: str, requirement_json: dict) -> Optional[Project]:
    ...
    def update_selected_option(self, project_id: str, option_json: dict) -> Optional[Project]:
        p = self.get(project_id)
        if p:
